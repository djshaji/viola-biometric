...
<div class="section m-3 p-3 shadow">
  ...
  <div class="card-footer text-muted justify-content-center d-flex">
    ...
    <button class="m-2 btn btn-danger" onclick="do_post ('/api/index.php', 'my-body', reload, true)" ><i class="fas fa-trash me-2"></i>Delete</button>
  </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button onclick="do_post ('/api/index.php', 'add', reload, true)" type="button" class="btn btn-primary"><i class="fas fa-plus-circle me-2"></i>Add Students</button>
      </div>
    </div>
  </div>
</div>
